{{ config(
    ...
    pre_hook="INSERT INTO {{ ref('audit_log') }} (table_name, operation, start_time, status) VALUES ('go_meeting_facts', 'transform_start', CURRENT_TIMESTAMP(), 'RUNNING')",
    post_hook="INSERT INTO {{ ref('audit_log') }} (table_name, operation, end_time, status) VALUES ('go_meeting_facts', 'transform_end', CURRENT_TIMESTAMP(), 'SUCCESS')"
) }}
